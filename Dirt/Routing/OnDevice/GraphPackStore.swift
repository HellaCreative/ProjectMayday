...
final class GraphPackStore {
    ...
    private func routeOnDeviceChained(
        ...
        func search(
            ...
            if regionIndex == regions.count - 1 {
                let final = await routeOnDeviceInRegion(
                    ...
                    priorEdgeIds: usedEdges, priorEdgeHistory: usedEdgeHistory,
                    arrivalEdgeId: incomingEdgeId,
                    backtrackFactor: backtrackFactor,
                    impassableRecovery: impassableRecovery, sessionSeed: sessionSeed,
            ...
            for anchor in anchors.prefix(8) {
                ...
                if let result = await search(
                    ...
                    usedEdgeHistory: Array((usedEdgeHistory + routed.edgeIds).suffix(256)),
        ...
        if let result = await search(
            ...
            usedEdgeHistory: Array(
                (priorEdgeHistory.isEmpty ? Array(priorEdgeIds) : priorEdgeHistory).suffix(256)
            ),
