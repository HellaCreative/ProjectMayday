...
final class MapState {
    ...
    /// A second, explicit tap on the already-selected planner pin. This is
    /// separate from MapLibre's programmatic re-selection callback.
    var onSelectedPlannerPinTap: ((String) -> Void)?
