...
| **BC** | Digital Road Atlas resource/trail | **OSM+DRA (shipping / capped)** | Capillary is DRA `ROAD_CLASS` resource + trail (~220k ingest; trail preferred). Recreation excluded (often MTB/hike). FTEN retired as pack capillary. |
