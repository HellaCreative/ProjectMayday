...
| Place/address search text and a map-region hint | Rider enters at least two characters in Search | Apple Maps through MapKit local search | No DIRT account ID is included | No | Find a place; selected coordinates are routed separately by the pack engine |
