...
**Status:** product intent retained; previous implementation failed physical-device
qualification and was removed in recovery commits `73312b4` and `07211ba`.
No implementation or release qualification is claimed. Work resumes in small,
independently checked slices against the frozen V4 release.

**Recovery clarifications — September 7, 2026 (take precedence below):**
- Previously ridden roads must not be deleted indiscriminately. Scope history
  to the rider leg and permit the minimum legal departure to a usable junction
  at a rider pin, fuel stop, cul-de-sac, ferry, or regional boundary.
- Fuel-on routing is one rider operation: return a complete, fuel-proven ride
  or fail honestly. Preserve a computed foundation internally to avoid duplicate
  work; an advisory foundation is not a fuel-qualified success.
- Exact physical regression: 44.76484,-63.34023 to 43.47454,-65.60197,
  Dirt, Allow Unknown off, 260 km tank and 10% reserve (234,000 m usable).
- Existing navigation behavior remains frozen. Do not change obstruction or
  in-ride behavior incidentally while recovering route planning.
- Actual production remains untouched. Matching stable DIRT DEV publication
  requires Richard's explicit authorization; GitHub backup requires device
