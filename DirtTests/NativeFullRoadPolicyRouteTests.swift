...
struct NativeFullRoadPolicyRouteTests {
            ...
            for profile in [RouteProfile.cleanest, .dirt, .balanced] {
                for avoidMotorways in [false, true] {
                    for initialFuel in [false, true] {
                        ...
                        preferences.avoidHighways = avoidMotorways
                        preferences.preferDifferentRoads = true
                        reference.ridePreferences = preferences
                        reference.useSharedFullRoadPolicy = false
                        reference.useSharedCleanPolicyReads = true
                        var extracted = reference
                        extracted.useSharedFullRoadPolicy = true
