...
@Suite("Native retrace callback equivalence", .serialized)
struct NativeRetraceCallbackTests {
    @Test func nativeRoutesMatchWithCombinedAndSplitCallbacks() throws {
    ...
    private func route(profile: RouteProfile,seed: UInt64,enabled: Bool) throws -> OnDeviceRouter.Result {
        ...
        router.useCombinedRetraceCallback=enabled
