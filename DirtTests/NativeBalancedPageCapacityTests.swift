...
@Suite("Native Balanced page equivalence", .serialized)
struct NativeBalancedPageCapacityTests {
    @Test func nativeRoutesMatchWith32And256LabelPages() throws {
    ...
    private func route(profile: RouteProfile,seed: UInt64,enabled: Bool) throws -> OnDeviceRouter.Result {
        ...
        router.balancedLabelPageCapacity=enabled ? 32 : 256
