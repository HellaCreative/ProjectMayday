...
struct DirtTests {
    @Test func debugBuildUsesIsolatedDevelopmentBackends() {
        ...
        #expect(AppConfig.packFileURL(version: AppConfig.v4ConnectionRevision, regionId: "on-s", fileName: "cross-pack-seams.v2.json")
            == AppConfig.v4ConnectionBaseURL.appendingPathComponent("on-s/cross-pack-seams.v2.json"))
