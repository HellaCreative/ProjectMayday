...
from multi_endpoint_astar import extend
...
identity_files = [source, querySource, b/'RestrictionSetter.java', b/'QueryGraph.java',
                  ...
                  astarSource,b/'DirtMultiEndpointAStar.java',here/'multi_endpoint_astar.py',r/'tools/graphhopper-web-11.0.jar']
