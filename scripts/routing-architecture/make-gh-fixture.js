...
if(process.argv[3]==="loops"){nodes.push({id:7,lon:-62.992,lat:45.013},{id:8,lon:-62.988,lat:45.014});ways.push({id:16,nodeIds:[2,7,8,2],tags:{highway:"unclassified",access:"yes",surface:"gravel"}});}
...
};variants.loops=variants.no;pack.restrictions=variants[variant];if(!pack.restrictions)throw Error("Unknown fixture variant");
