...
for(const c of cases) {
 ...
 assert.equal(shape.state,'complete');if(['moved','near-dalhousie','dalhousie'].includes(c.id)){assert.ok(shape.repeatedRoadMeters<2000);assert.ok(surface.knownDirtPercent>60);}
