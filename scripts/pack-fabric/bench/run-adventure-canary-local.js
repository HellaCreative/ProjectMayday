...
(async()=>{for(const profile of (process.env.REBUILD_CAPE_UNKNOWN?['dirt']:['dirt','balanced','cleanest'])){
 const body={profile,locations:[{lat:44.76484,lon:-63.34023},(process.env.REBUILD_CAPE_UNKNOWN?{lat:46.873410,lon:-60.531752}:{lat:43.47454,lon:-65.60197})],accessPolicy:{motorizedUnknown:process.env.REBUILD_CAPE_UNKNOWN==='true'},fuel:{usableRangeMeters:process.env.REBUILD_CAPE_UNKNOWN?225000:270000,firstLegMaxMeters:process.env.REBUILD_CAPE_UNKNOWN?225000:270000,windowMaxStops:4,windowTimeBudgetMs:20000,routeFirstPlan:true,ensureDestinationFuelEscape:true}};
