...
(async()=>{for(const profile of (process.env.REBUILD_REQUEST_PATH?[JSON.parse(fs.readFileSync(process.env.REBUILD_REQUEST_PATH)).profile]:process.env.REBUILD_CAPE_UNKNOWN?['dirt']:['dirt','balanced','cleanest'])){
