...
(async()=>{for(const profile of ['dirt','balanced','cleanest']){
 const body={profile,locations:[{lat:44.76484,lon:-63.34023},{lat:43.47454,lon:-65.60197}],accessPolicy:{motorizedUnknown:false},fuel:{usableRangeMeters:270000,firstLegMaxMeters:270000,windowMaxStops:4,windowTimeBudgetMs:20000,routeFirstPlan:true,ensureDestinationFuelEscape:true}};
