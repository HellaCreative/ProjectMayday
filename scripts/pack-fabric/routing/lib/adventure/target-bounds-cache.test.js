...
for(const releaseGraph of [false,true])test('bounds share only identical topology, cost, target and stopping node; release graph '+releaseGraph,()=>{
 const cache=createTargetBoundsCache({releaseGraph}),cost=a=>a.distanceMeters;
