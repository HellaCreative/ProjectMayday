...
function createRideAlternativeContext({maxReverseBytes=64*1024*1024}={}){return {preparationCache:createPreparationCache(),reverseCostCache:createReverseCostCache({maxBytes:maxReverseBytes}),stationMatchCache:createStationMatchCache()};}
