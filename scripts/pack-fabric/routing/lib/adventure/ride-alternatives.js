...
function createRideAlternativeContext({maxReverseBytes=64*1024*1024,useIncomingBounds=false,fastNeutralTurns=false}={}){return {fastNeutralTurns,preparationCache:createPreparationCache(),reverseCostCache:createReverseCostCache({maxBytes:maxReverseBytes,useIncomingBounds}),stationMatchCache:createStationMatchCache()};}
