...
function buildRideAlternatives(options) {
 ...
 pool.sort((a,b)=>(a.result.road.urbanMeters||0)-(b.result.road.urbanMeters||0)||compareSurface(profile,a.result.road.surface,b.result.road.surface)||a.id.localeCompare(b.id));
